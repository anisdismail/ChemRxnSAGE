...
This module implements the Transformer architecture, including the encoder and decoder layers,
multi-head attention, and position-wise feed-forward networks.
...
class Transformer(nn.Transformer):
    ...
    def __init__(self, ntoken, ninp, nhead, nhid, nlayers, max_len, dropout=0.5):
